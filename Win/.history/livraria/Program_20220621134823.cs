...
var connectionString = $"Data Source={server};Initial Catalog={database};Password={password};User ID={user};Persist Security Info=True;";

var conexao = builder.Configuration.GetConnectionStringm
